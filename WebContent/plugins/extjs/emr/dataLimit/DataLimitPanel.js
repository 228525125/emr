DataLimitPanel = Ext.extend(Ext.Viewport, {
    layout: 'border',
    id: 'datalimitpanel',
    createForm:function(){
		if(!this.fp||null==this.fp){
			this.fp = new DataLimitFormPanel({
    ...
    initComponent: function() {
        ...
        DataLimitPanel.superclass.initComponent.call(this);
        
        this.on('render',function(t){        	
        	this.gp = Ext.getCmp('datalimitgrid');
        	this.tree = Ext.getCmp('datalimittreepanel');	
			this.store.load();
