OrganizationPanel = Ext.extend(Ext.Viewport, {
    layout: 'border',
    id: 'organizationpanel',
    createForm:function(){
		if(!this.fp||null==this.fp){
			this.fp = new OrganizationFormPanel({
    ...
    initComponent: function() {
		...
		this.store = new Ext.data.JsonStore({
			...
			root:"result",
			fields:["id","code","name","auxCode","disabled","description","address","contact","legalPerson","parent"],
			listeners:{
                ...
                items: [
                    {
                        ...
                        loader: {
                            url: 'organization.do?cmd=tree',                            
                            listeners: {
                        		'beforeload':function(loader,node){
	    							loader.baseParams.organizationId=node.id;
	    						}
                        	}
                        },
                        listeners: {                        	
        ...
        OrganizationPanel.superclass.initComponent.call(this);
        
        this.on('render',function(t){        	
        	this.gp = Ext.getCmp('organizationgrid');
        	this.tree = Ext.getCmp('organizationtreepanel');	
			this.store.load();
