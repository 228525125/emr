...
public class EmployeeAction extends BaseAction {
	...
	public Page doList(WebForm form) {
		...
		if(null!=form.get("query")&&!"".equals(form.get("query").toString())){			
			...
			qo.addQuery("(obj.description like '%"+query+"%' or obj.department.tuhao like '%"+query+"%' or obj.department.model like '%"+query+"%' or obj.department.code like '%"+query+"%' or obj.department.name like '%"+query+"%')", null);
		}else{
			//根据部门查询职员列表
